#
#  Be sure to run `pod spec lint Hostess.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
					A Swift implementation of NSHost (Host in Swift) that works on iOS, OS X and tvOS. Hostess.swift is safe to use in a framework because it does not require a bridging header.
  ...
  s.homepage     = "https://github.com/rjstelling/Hostess.swift"
  ...
  s.social_media_url   = "http://twitter.com/rjstelling"
  ...
  s.source_files  = "Projects/Hostess/Hostess/", "Projects/Hostess/Hostess/**/*.{h,m}"
  s.exclude_files = "Projects/Hostess/Hostess//Exclude"
